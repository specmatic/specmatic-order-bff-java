...
class ContractTests : SpecmaticContractTest {
    companion object {
        ...
        @BeforeAll
        fun setUp() {
            println("Using specmatic kafka - ${AsyncVersion.describe()}")
            ...
            kafkaMock = AsyncMock.startInMemoryBroker(KAFKA_MOCK_HOST, KAFKA_MOCK_PORT, AsyncProtocol.KAFKA_PROTOCOL)
            Thread.sleep(2000)
