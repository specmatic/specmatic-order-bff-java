...
After running the contract tests, you can view the test reports generated by Specmatic in the following location: [build/reports/specmatic/index.html](build/reports/specmatic/index.html)
